...
namespace Pacman
{
    public class Pacman
    {
        ...
        public Queue<int> xHistory = new Queue<int>(50);
        public Queue<int> yHistory = new Queue<int>(50);
        ...
        public void MovePacman(int direction)
        {
            ...
            if (CanMove)
            {
                ...
                xHistory.Enqueue(xCoordinate);
                yHistory.Enqueue(yCoordinate);
                if (xHistory.Count == 50)
                    xHistory.Dequeue();
                if (yHistory.Count == 50)
                    yHistory.Dequeue();
